! function(t, e) {
    ...
    function it(t) {
        Qe.isVisible() && ct !== t.target.value && Qe.resetValidationMessage(), ct = t.target.value
    }
    ...
    function at(t, e) {
        ...
        e.showConfirmButton || e.showCancelButton || G(n), R(n, e, "actions"), gt(o, "confirm", e), gt(i, "cancel", e), e.buttonsStyling ? function(t, e, n) {
            ut([t, e], z.styled), n.confirmButtonColor && (t.style.backgroundColor = n.confirmButtonColor);
        ...
        }(o, i, e) : (st([o, i], z.styled), o.style.backgroundColor = o.style.borderLeftColor = o.style.borderRightColor = "", i.style.backgroundColor = i.style.borderLeftColor = i.style.borderRightColor = ""), e.reverseButtons && o.parentNode.insertBefore(i, o)
    }
    var ct, ut = function(t, e) {
        ...
        ft = function(t) {
            if (! function() {
                    var t = y();
                    t && (t.parentNode.removeChild(t), st([document.documentElement, document.body], [z["no-backdrop"], z["toast-shown"], z["has-column"]]))
                ...
                n.appendChild(e),
                    ...
                    function(t) {
                        "rtl" === window.getComputedStyle(t).direction && ut(y(), z.rtl)
                    }(n),
                    function() {
                        var t = P(),
                            e = lt(t, z.input),
    ...
    function gt(t, e, n) {
        ...
        }(e), "Button")], "inline-block"), t.innerHTML = n["".concat(e, "ButtonText")], t.setAttribute("aria-label", n["".concat(e, "ButtonAriaLabel")]), t.className = z[e], R(t, n, "".concat(e, "Button")), ut(t, n["".concat(e, "ButtonClass")])
    }

    function vt(t, e) {
        var n = y();
        n && (function(t, e) {
            "string" == typeof e ? t.style.background = e : e || ut([document.documentElement, document.body], z["no-backdrop"])
            ...
            e in z ? ut(t, z[e]) : (D('The "position" parameter is not valid, defaulting to "center"'), ut(t, z.center))
    ...
    var yt = {
        ...
        At = {};
    At.text = At.email = At.password = At.number = At.tel = At.url = function(t, e) {
    ...
    function St(t, i) {
        ...
        X(r), r.innerHTML = "";
        var a = parseInt(null === i.currentProgressStep ? Qe.getQueueStep() : i.currentProgressStep);
        a >= i.progressSteps.length && D("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), i.progressSteps.forEach(function(t, e) {
            ...
            if (r.appendChild(n), e === a && ut(n, z["active-progress-step"]), e !== i.progressSteps.length - 1) {
                var o = function(t) {
                    var e = document.createElement("li");
                    return ut(e, z["progress-step-line"]), t.progressStepsDistance && (e.style.width = t.progressStepsDistance), e
                }(t);
                r.appendChild(o)
            }
        })
            ...
            function(t, e) {
                ...
                if (n && e.icon === n.icon && k()) R(k(), e, "icon");
                    ...
                    if (-1 !== Object.keys(W).indexOf(e.icon)) {
                        ...
                        X(o), Ht(o, e), Mt(), R(o, e, "icon"), ut(o, e.showClass.icon)
    ...
    function Tt(t, e) {
        ! function(t, e) {
            var n = C();
            J(n, "width", e.width), J(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = z.popup, e.toast ? (ut([document.documentElement, document.body], z["toast-shown"]), ut(n, z.toast)) : ut(n, z.modal), R(n, e, "popup"), "string" == typeof e.customClass && ut(n, e.customClass), dt(n) && ut(n, e.showClass.popup)
        }(0, e), vt(0, e), Et(t, e), Bt(t, e), at(0, e),
            function(t, e) {
                var n = M();
    ...
    function Vt() {
        ...
        var e = L(),
            n = E();
        X(e), X(n, "inline-block"), ut([t, e], z.loading), n.disabled = !0, t.setAttribute("data-loading", !0), t.setAttribute("aria-busy", !0), t.focus()
    }
    ...
    function It() {
        return new Promise(function(t) {
            ...
            Ft.restoreFocusTimeout = setTimeout(function() {
                Ft.previousActiveElement && Ft.previousActiveElement.focus ? (Ft.previousActiveElement.focus(), Ft.previousActiveElement = null) : document.body && document.body.focus(), t()
            }, 100), void 0 !== e && void 0 !== n && window.scrollTo(e, n)
        })
    }

    function qt() {
        if (Ft.timeout) return function() {
            var t = H(),
    ...
    var Ut = [],
        ...
        zt = ["title", "titleText", "text", "html", "icon", "customClass", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeight", "imageAlt", "progressSteps", "currentProgressStep"],
        Wt = {
            ...
            mixin: function(n) {
                return function(t) {
                    ...
                    return function(t, e) {
                        ...
                        key: "_main",
                        value: function(t) {
                            return p(u(e.prototype), "_main", this).call(this, c({}, n, t))
                        }
                    }]), e
                }(this)
            },
    ...
    function Zt() {
        ...
        if (t) {
            ...
            t.showConfirmButton || (G(e.confirmButton), t.showCancelButton || G(e.actions)), st([e.popup, e.actions], z.loading), e.popup.removeAttribute("aria-busy"), e.popup.removeAttribute("data-loading"), e.confirmButton.disabled = !1, e.cancelButton.disabled = !1
        }
    }
    ...
    function te(t, e, n, o) {
        n ? ie(t, o) : (It().then(function() {
            return ie(t, o)
        }), Ft.keydownTarget.removeEventListener("keydown", Ft.keydownHandler, {
            capture: Ft.keydownListenerCapture
        }), Ft.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), I() && (null !== Y.previousBodyPadding && (document.body.style.paddingRight = "".concat(Y.previousBodyPadding, "px"), Y.previousBodyPadding = null), function() {
            if (q(document.body, z.iosfix)) {
                var t = parseInt(document.body.style.top, 10);
                st(document.body, z.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t
            }
        }(), "undefined" != typeof window && $t() && window.removeEventListener("resize", Jt), m(document.body.children).forEach(function(t) {
            t.hasAttribute("data-previous-aria-hidden") ? (t.setAttribute("aria-hidden", t.getAttribute("data-previous-aria-hidden")), t.removeAttribute("data-previous-aria-hidden")) : t.removeAttribute("aria-hidden")
        })), st([document.documentElement, document.body], [z.shown, z["height-auto"], z["no-backdrop"], z["toast-shown"], z["toast-column"]])
    }
    ...
    function ee(t) {
        ...
        if (e) {
            ...
            if (n && !q(e, n.hideClass.popup)) {
                ...
                var i = y();
                st(i, n.showClass.backdrop), ut(i, n.hideClass.backdrop),
                    function(t, e, n) {
                        var o = y(),
                            i = ht && et(e),
                            r = n.onClose,
    ...
    var oe = function(t, e, n, o) {
            Ft.swalCloseEventFinishedCallback = te.bind(null, t, n, K(), o), e.addEventListener(ht, function(t) {
                t.target === e && (Ft.swalCloseEventFinishedCallback(), delete Ft.swalCloseEventFinishedCallback)
            })
        },
        ie = function(t, e) {
            setTimeout(function() {
                null !== e && "function" == typeof e && e(), C() || function(t) {
                    delete t.params, delete Ft.keydownHandler, delete Ft.keydownTarget, ne(yt), ne(Gt)
                }(t)
            })
        };
    ...
    function de(t) {
        var e = y(),
            n = C();
        "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), Ce(e, n, t), ye(e, n), I() && we(e, t.scrollbarPadding), K() || Ft.previousActiveElement || (Ft.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() {
            return t.onOpen(n)
        })
    }

    function pe(t, e) {
        "select" === e.input || "radio" === e.input ? Ae(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && v(e.inputValue) && Be(t, e)
    }
    ...
    var ye = function(t, e) {
            ht && et(e) ? (t.style.overflowY = "hidden", e.addEventListener(ht, le.bind(null, e, t))) : t.style.overflowY = "auto"
        },
        we = function(t, e) {
            ! function() {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !q(document.body, z.iosfix)) {
                    ...
                    document.body.style.top = "".concat(-1 * t, "px"), ut(document.body, z.iosfix), Xt()
                }
            }(), "undefined" != typeof window && $t() && (Jt(), window.addEventListener("resize", Jt)), m(document.body.children).forEach(function(t) {
                t === y() || function(t, e) {
        ...
        Ce = function(t, e, n) {
            ut(t, n.showClass.backdrop), X(e), ut(e, n.showClass.popup), ut([document.documentElement, document.body], z.shown), n.heightAuto && n.backdrop && !n.toast && ut([document.documentElement, document.body], z["height-auto"])
        },
        ke = function(t) {
        ...
        Ae = function(e, n) {
            ...
            var i = P();
            v(n.inputOptions) ? (Vt(), n.inputOptions.then(function(t) {
                e.hideLoading(), o(t)
        ...
        Te = function(e, n) {
            ...
            n.inputValidator ? (e.disableInput(), Promise.resolve().then(function() {
                ...
                e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : Le(e, n, o)
            })) : e.getInput().checkValidity() ? Le(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
        },
        Le = function(e, t, n) {
            (t.showLoaderOnConfirm && Vt(), t.preConfirm) ? (e.resetValidationMessage(), Promise.resolve().then(function() {
                return t.preConfirm(n, t.validationMessage)
            }).then(function(t) {
                dt(S()) || !1 === t ? e.hideLoading() : he(e, void 0 === t ? n : t)
            })) : he(e, n)
        },
        Oe = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"],
        Me = ["Escape", "Esc"],
        He = function(t, e, n, o) {
            n.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? je(t, e, n) : "Tab" === e.key ? Ve(e, n) : -1 !== Oe.indexOf(e.key) ? Ie() : -1 !== Me.indexOf(e.key) && qe(e, n, o)
        },
        je = function(t, e, n) {
        ...
        De = function(e) {
            e.popup.onmousedown = function() {
                e.container.onmouseup = function(t) {
                    e.container.onmouseup = void 0, t.target === e.container && (Ne = !0)
                }
            }
        },
        Ue = function(e) {
            e.container.onmousedown = function() {
                e.popup.onmouseup = function(t) {
                    e.popup.onmouseup = void 0, t.target !== e.popup && !e.popup.contains(t.target) || (Ne = !0)
                }
            }
        },
        Fe = function(e, n, o) {
            e.container.onclick = function(t) {
                Ne ? Ne = !1 : t.target === e.container && F(n.allowOutsideClick) && o(_.backdrop)
            }
        };
    var _e = function(t, e, n) {
            var o = H();
            G(o), e.timer && (t.timeout = new ce(function() {
        ...
        ze = function(t, e) {
            if (!e.toast) return F(e.allowEnterKey) ? e.focusCancel && dt(t.cancelButton) ? t.cancelButton.focus() : e.focusConfirm && dt(t.confirmButton) ? t.confirmButton.focus() : void ve(0, -1, 1) : We()
        },
        We = function() {
            document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()
        };
    var Ke, Ye = Object.freeze({
        hideLoading: Zt,
        disableLoading: Zt,
        getInput: function(t) {
        ...
        showValidationMessage: function(t) {
            ...
            var o = this.getInput();
            o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedBy", z["validation-message"]), Q(o), ut(o, z.inputerror))
        },
        resetValidationMessage: function() {
            var t = yt.domCache.get(this);
            t.validationMessage && G(t.validationMessage);
            var e = this.getInput();
            e && (e.removeAttribute("aria-invalid"), e.removeAttribute("aria-describedBy"), st(e, z.inputerror))
        },
        ...
        _main: function(t) {
            ! function(t) {
                for (var e in t) Nt(i = e) || D('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== Kt.indexOf(o) && D('The parameter "'.concat(o, '" is incompatible with toasts'))), Dt(n = e) && g(n, Dt(n));
                var n, o, i
            }(t), C() && Ft.swalCloseEventFinishedCallback && (Ft.swalCloseEventFinishedCallback(), delete Ft.swalCloseEventFinishedCallback), Ft.deferDisposalTimer && (clearTimeout(Ft.deferDisposalTimer), delete Ft.deferDisposalTimer);
            var e = function(t) {
            ...
            se(e), Object.freeze(e), Ft.timeout && (Ft.timeout.stop(), delete Ft.timeout), clearTimeout(Ft.restoreFocusTimeout);
            var n = function(t) {
                var e = {
                    popup: C(),
                    container: y(),
            ...
            return Tt(this, e), yt.innerParams.set(this, e),
                function(n, o, i) {
                    return new Promise(function(t) {
                        var e = function t(e) {
                            n.closePopup({
        ...
        update: function(e) {
            ...
            var o = {};
            Object.keys(e).forEach(function(t) {
                Qe.isUpdatableParameter(t) ? o[t] = e[t] : D('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
            var i = c({}, n, o);
            Tt(this, i), yt.innerParams.set(this, i), Object.defineProperties(this, {
                params: {
    ...
    function Ze() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && h("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), Ke = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    }, c(Ze.prototype, Ye), c(Ze, Yt), Object.keys(Ye).forEach(function(e) {
        Ze[e] = function() {
            var t;
            if (Ke) return (t = Ke)[e].apply(t, arguments)
        }
    }), Ze.DismissReason = _, Ze.version = "9.4.0";
    var Qe = Ze;
