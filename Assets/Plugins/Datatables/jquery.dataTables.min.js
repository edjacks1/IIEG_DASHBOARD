...
(function(f) {
    ...
    function ub(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
            g = '<input type="search" class="texto-de-forms" required/>',
            k = '<label> <i class="fas fa-search mr-2"></i>Buscar</label>';

        k = k.match(/_INPUT_/) ? k.replace("_INPUT_", g) : g + k;

        b = f("<div/>", {
            id: h.f ? null : c + "_filter",
            "class": "grupo-de-forms texto-animado-de-forms",
            "style": "margin-top:40px !important;"
        }).append(f("<div/>").append(k));
    ...
    function tb(a) {
        ...
        var l = f("<div><label/></div>").addClass(b.sLength + " mt-5 ml-4");
